...
function Supercut() {
  ...
  return (
      <div>
          <BackHomeButton/>
        {
          <div className={styles.videoCard + " " + styles.tableHead}>
            <div className={styles.tableHeading}>
              ...
              {!finishedSmallLoading ? <FontAwesomeIcon className={styles.spinning + " " + styles.smallLoading} icon={faCircleNotch} /> : null}
            <FontAwesomeIcon
                icon={faCircleCheck}
        ...
        <FontAwesomeIcon icon={faCirclePlus} className={styles.plus} onClick={() => { setaddNew(true) }} />
        {addNew ?
